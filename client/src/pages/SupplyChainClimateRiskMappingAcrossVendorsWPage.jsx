...
export default function SupplyChainClimateRiskMappingAcrossVendorsWPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/cf-supply-chain-climate-risk-mapping-across-vendors-w/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb', maxWidth: 980 }}>
      <h2 style={{ marginTop: 0 }}>Supply-chain climate-risk mapping across vendors with elevation/flood overlays</h2>
      <p style={{ color: '#9ca3af', fontSize: 13 }}>
        Endpoint: <code>/api/cf-supply-chain-climate-risk-mapping-across-vendors-w/run</code>. Submit context as text; the backend calls OpenRouter and returns structured JSON.
      </p>
